...
**The Features of To Do List are**
...
<p align="center">
  <img src="./images/ToDoListReact.png" alt="Basic UI" width="300px" />
</p>
...
**To Do List** was an Html,CSS&JavaScript-based project with the implementation of Webpack implementation including development server. Currently doing it with <a href="https://github.com/microverseinc/curriculum-react-redux/blob/main/math-magicians/exercises/react_tutorial.md">React</a> with same functionality.



# Responsive website for communities events and particpants details <a name="about-project"></a>
This is a implementation of SINGLE PAGE APPLICATION widely known as SPA. The project has been done now with <a href="https://github.com/microverseinc/curriculum-react-redux/blob/main/math-magicians/exercises/react_tutorial.md">React</a>.
...
<ul>
  <li><a href="https://ibaslogic.com/react-tutorial-for-beginners/">See the Project Requirement</a></li>
...
This project is deployed at github pages you can clone it here. [Please click to clone](https://github.com/RHK-MICROVERSE/todolistreact)
...
Feel free to check the [issues page](https://github.com/RHK-MICROVERSE/todolistreact/issues).
